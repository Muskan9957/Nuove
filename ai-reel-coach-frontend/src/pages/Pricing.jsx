...
const PLANS = [
  {
    id:       'free',
    name:     'Free',
    tagline:  'Explore and start creating',
    priceM:   0,
    priceY:   0,
    badge:    null,
    accent:   '#6B7280',
    ...
    features: [
      ...
      { text: 'Caption Generator (3/day)',               ok: true  },
      { text: 'Hook Library (browse only)',              ok: true  },
      { text: 'Generic daily brief',                     ok: true  },
  ...
  },
  {
    ...
    features: [
      ...
      { text: 'Creator Coach (AI chat)',                 ok: true  },
      { text: 'Voice Assistant',                         ok: true  },
      { text: 'Custom brand voice (My Voice)',           ok: false },
    ],
  },
  {
    id:       'studio',
    ...
    features: [
      ...
      { text: 'Custom brand voice (My Voice)',           ok: true  },
      { text: 'Priority AI (2× faster responses)',      ok: true  },
      { text: 'Advanced performance reports',            ok: true  },
      { text: 'Script retakes & refinements (unlimited)', ok: true },
...
const FAQS = [
  ...
  },
  {
    ...
    a: 'Pro (₹99/mo) gives you unlimited scripts, analytics, coach, and your niche-personalised daily brief. Studio (₹499/mo) adds your custom brand voice (My Voice), priority AI, advanced reports, content remix, and early feature access.',
  },
  {
